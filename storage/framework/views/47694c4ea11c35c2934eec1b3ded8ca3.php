...
<?php $__env->startSection('title', 'Data Satker'); ?>
<?php $__env->startSection('breadcrumb', 'Data Satker'); ?>
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e($satkers->count()); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e(number_format($satkers->sum('polri_count'))); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e(number_format($satkers->sum('pns_count'))); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e(number_format($satkers->sum('polri_count') + $satkers->sum('pns_count'))); ?></span>
        </div>
    </div>
</div>
...
<div class="table-container shadow-sm">
    <div class="card-header-simple" style="display: flex; justify-content: space-between; align-items: center; background: #fff; padding: 16px 20px; border-bottom: 1px solid #F3F4F6;">
        ...
        <span class="role-pill"><?php echo e($satkers->count()); ?> Satker Terdaftar</span>
    </div>
    <table class="user-table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $satkers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $satker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td style="text-align: center; color: #9CA3AF; font-size: 13px; font-weight: 600;"><?php echo e($index + 1); ?></td>
                <td>
                    <span style="font-weight: 600; color: #111827;"><?php echo e($satker->name); ?></span>
                </td>
                <td style="text-align: center;">
                    <form method="POST" action="<?php echo e(route($routePrefix . '.satkers.update-personnel', $satker)); ?>" class="inline-personnel-form" id="form-<?php echo e($satker->id); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                        <div style="display: flex; align-items: center; gap: 8px; justify-content: center;">
                            <input type="number" name="polri_count" value="<?php echo e($satker->polri_count); ?>"
                                min="0" class="input-inline" style="width: 70px; text-align: center;"
                                oninput="showSaveBtn('<?php echo e($satker->id); ?>')">
                        </div>
                </td>
                <td style="text-align: center;">
                        <div style="display: flex; align-items: center; gap: 8px; justify-content: center;">
                            <input type="number" name="pns_count" value="<?php echo e($satker->pns_count); ?>"
                                min="0" class="input-inline" style="width: 70px; text-align: center;"
                                oninput="showSaveBtn('<?php echo e($satker->id); ?>')">
                            <button type="submit" class="btn-save-inline" id="save-<?php echo e($satker->id); ?>" title="Simpan Perubahan" style="display: none;">
                ...
                <td style="text-align: center;">
                    <span style="font-weight: 700; color: #4B5563; background: #F9FAFB; padding: 4px 12px; border-radius: 6px; font-size: 13px;">
                        <?php echo e(number_format($satker->polri_count + $satker->pns_count)); ?>

                    </span>
                </td>
                <td style="text-align: center;">
                    <div class="action-buttons" style="justify-content: center;">
                        <button class="btn-icon blue" title="Edit Satker" onclick="openEditModal(<?php echo e(json_encode($satker)); ?>)">
                            <i class="ri-edit-line"></i>
                        </button>
                        <form method="POST" action="<?php echo e(route($routePrefix . '.satkers.destroy', $satker)); ?>"
                            onsubmit="return confirm('Yakin ingin menghapus satker <?php echo e($satker->name); ?>?')">
                            <?php echo csrf_field(); ?>
        ...
        <?php if($satkers->isNotEmpty()): ?>
        <tfoot>
            <tr style="background: #FAFAFA; border-top: 2px solid #F3F4F6;">
                <td></td>
                <td style="font-weight: 700; color: #111827;">REKAPITULASI TOTAL</td>
                <td style="text-align: center; font-weight: 800; color: #B91C1C;"><?php echo e(number_format($satkers->sum('polri_count'))); ?></td>
                <td style="text-align: center; font-weight: 800; color: #B91C1C;"><?php echo e(number_format($satkers->sum('pns_count'))); ?></td>
                <td style="text-align: center; font-weight: 800; color: #111827; background: #F3F4F6;"><?php echo e(number_format($satkers->sum('polri_count') + $satkers->sum('pns_count'))); ?></td>
                <td></td>
            </tr>
        </tfoot>
        <?php endif; ?>
...
<div class="modal-overlay" id="addModal">
    <div class="modal shadow-xl" style="max-width: 450px;">
        ...
        <form method="POST" action="<?php echo e(route($routePrefix . '.satkers.store')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1 KAPOR\si-kapor\resources\views/admin/satkers/index.blade.php ENDPATH**/ ?>