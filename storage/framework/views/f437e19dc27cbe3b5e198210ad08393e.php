...
<?php $__env->startSection('breadcrumb', 'Manajemen Pengguna'); ?>
...
<div id="addUserSection" class="inline-card" style="display: <?php echo e($errors->any() ? 'block' : 'none'); ?>; margin-bottom: 24px;">
        ...
        <div class="card-body-simple">
            <div class="form-grid-2">
                <div class="form-group-simple">
                    ...
                    <input type="text" name="nrp_nip" value="<?php echo e(old('nrp_nip')); ?>" 
                        class="form-input-simple <?php $__errorArgs = ['nrp_nip'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group-simple">
                     ...
                     <input type="text" name="name" value="<?php echo e(old('name')); ?>" 
                         class="form-input-simple <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                 ...
                 <div class="form-group-simple">
                     ...
                     <div class="password-wrapper-simple">
                         <input type="password" name="password" id="inline_password" 
                             class="form-input-simple <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                 ...
                 <div class="form-group-simple">
                     <label>Peran</label>
                     <div class="custom-select form-input-simple <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                         ...
                         <div class="custom-options" style="background: #fff !important;">
                             <div class="options-scroll">
                                 ...
                                 <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <div class="option <?php echo e(old('role') == $role->name ? 'selected' : ''); ?>" 
                                          onclick="setSelectValue('role', '<?php echo e($role->name); ?>', '<?php echo e(ucfirst($role->name)); ?>', this)">
                         ...
                         <input type="hidden" name="role" id="role_input" value="<?php echo e(old('role')); ?>" required>
                     </div>
             ...
             <div class="form-grid-2" style="margin-top: 16px;">
                 <div class="form-group-simple">
                     ...
                     <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" 
                         class="form-input-simple <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e($stats['total_admin_satker']); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e($stats['total_admin_polda']); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e($stats['total_personil']); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e($stats['active_users']); ?></span>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <span class="stat-number"><?php echo e($stats['inactive_users']); ?></span>
        </div>
    </div>
</div>
...
<div class="filter-bar">
    <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="filter-form" id="filterForm">
        <div class="search-input">
            <i class="ri-search-line"></i>
            <input type="text" name="search" id="searchInput" value="<?php echo e(request('search')); ?>" placeholder="Cari berdasarkan nama atau username..." autocomplete="off" oninput="debounceSearch()">
        ...
        <div class="custom-select-wrapper">
            <div class="custom-select" onclick="toggleDropdown(this)">
                ...
                <div class="custom-options" style="background: #fff !important;">
                    <div class="options-scroll">
                        ...
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="option <?php echo e(request('role') == $role->name ? 'selected' : ''); ?>" 
                                 onclick="selectOption(this, 'role', '<?php echo e($role->name); ?>', '<?php echo e(ucfirst($role->name)); ?>')">
                                <?php echo e(ucfirst($role->name)); ?>
            ...
            <input type="hidden" name="role" id="filter_role" value="<?php echo e(request('role')); ?>">
        </div>
        ...
        <div class="custom-select-wrapper">
            <div class="custom-select" onclick="toggleDropdown(this)">
                <div class="select-trigger">
                    <span>
                        <?php if(request('status') == 'active'): ?> Aktif 
                        <?php elseif(request('status') == 'inactive'): ?> Tidak Aktif 
                ...
                <div class="custom-options" style="background: #fff !important;">
                    <div class="options-scroll">
                        <div class="option <?php echo e(!request('status') ? 'selected' : ''); ?>" onclick="selectOption(this, 'status', '', 'Semua Status')">Semua Status</div>
                        <div class="option <?php echo e(request('status') == 'active' ? 'selected' : ''); ?>" onclick="selectOption(this, 'status', 'active', 'Aktif')">Aktif</div>
                        <div class="option <?php echo e(request('status') == 'inactive' ? 'selected' : ''); ?>" onclick="selectOption(this, 'status', 'inactive', 'Tidak Aktif')">Tidak Aktif</div>
                    </div>
                </div>
            </div>
            <input type="hidden" name="status" id="filter_status" value="<?php echo e(request('status')); ?>">
        </div>
    ...
    <div class="table-wrap">
        <table class="user-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="user-info">
                            <div class="avatar" style="background-color: <?php echo e(['#EF4444', '#F59E0B', '#10B981', '#3B82F6', '#6366F1', '#8B5CF6', '#EC4899'][ord($u->name[0]) % 7]); ?>;">
                                <?php echo e(strtoupper(substr($u->name, 0, 1))); ?>

                            </div>
                            <div class="details">
                                <span class="name"><?php echo e($u->name); ?></span>
                                <span class="username">@<span></span><?php echo e($u->nrp_nip); ?></span>
                            </div>
                        </div>
                    </td>
                    <td>
                    ...
                    <td class="last-active">
                        <div style="font-weight: 600; color: #111827;"><?php echo e($u->updated_at->translatedFormat('d M Y')); ?></div>
                        <div style="font-size: 11px; color: #9CA3AF;">Pukul <?php echo e($u->updated_at->format('H:i')); ?></div>
                    </td>
                    <td>
                        <div class="action-buttons">
                            <button class="btn-icon blue" onclick="openEditModal(<?php echo e(json_encode($u->load(['roles', 'personnel']))); ?>)" title="Edit Data">
                                <i class="ri-edit-line"></i>
                            </button>
                            
                            
                            <form method="POST" action="<?php echo e(route('admin.users.toggle-status', $u)); ?>" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn-icon <?php echo e($u->is_active ? 'orange' : 'green'); ?>" 
                                    title="<?php echo e($u->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>"
                                    <?php echo e(auth()->id() === $u->id ? 'disabled' : ''); ?>>
                                    <i class="<?php echo e($u->is_active ? 'ri-lock-line' : 'ri-lock-unlock-line'); ?>"></i>
                                </button>
                            </form>

                            
                            <button type="button" class="btn-icon red" title="Hapus Permanen" 
                                onclick="confirmDelete(<?php echo e($u->id); ?>, '<?php echo e($u->name); ?>')"
                                <?php echo e(auth()->id() === $u->id ? 'disabled' : ''); ?>>
        ...
        <div class="table-footer">
            <div class="footer-left">
                Menampilkan <?php echo e($users->firstItem() ?? 0); ?> hingga <?php echo e($users->lastItem() ?? 0); ?> dari <?php echo e($users->total()); ?> data
            ...
            <div class="footer-right">
                <div class="pagination-controls">
                    <a href="<?php echo e($users->url(1)); ?>" class="page-btn <?php echo e($users->onFirstPage() ? 'disabled' : ''); ?>" title="Halaman Pertama">
                        <i class="ri-double-left-line"></i>
                    </a>
                    
                    <a href="<?php echo e($users->previousPageUrl()); ?>" class="page-btn <?php echo e($users->onFirstPage() ? 'disabled' : ''); ?>" title="Halaman Sebelumnya">
                        <i class="ri-arrow-left-s-line"></i>
                    </a>
                    
                    <span class="page-info">Halaman <strong><?php echo e($users->currentPage()); ?></strong> dari <strong><?php echo e($users->lastPage()); ?></strong></span>
                    
                    <a href="<?php echo e($users->nextPageUrl()); ?>" class="page-btn <?php echo e(!$users->hasMorePages() ? 'disabled' : ''); ?>" title="Halaman Berikutnya">
                        <i class="ri-arrow-right-s-line"></i>
                    </a>
                    
                    <a href="<?php echo e($users->url($users->lastPage())); ?>" class="page-btn <?php echo e(!$users->hasMorePages() ? 'disabled' : ''); ?>" title="Halaman Terakhir">
...
<?php echo $__env->make('admin.users.modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1 KAPOR\si-kapor\resources\views/admin/users/index.blade.php ENDPATH**/ ?>